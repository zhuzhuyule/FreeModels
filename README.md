...
| [Gitee AI](https://ai.gitee.com)  | `gitee` | 204 | 44 | 146 | 部分模型完全免费，另有一批模型允许体验。 | [注册](https://ai.gitee.com) | — | [文档](https://ai.gitee.com/docs) | [JSON](https://ofind.cn/FreeModels/data/providers/gitee/models.json) |
...
共 **172** 个免费模型（限速免费 86 个、永久免费 53 个、试用 credits 24 个、日 token 配额 7 个、预览版 2 个）。
