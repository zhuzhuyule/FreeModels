...
| 项目 | 内容 |
|---|---|
| 内部 Provider ID | `gitee` |
| 官网 | [https://ai.gitee.com](https://ai.gitee.com) |
| 注册/登录 | [https://ai.gitee.com](https://ai.gitee.com) |
| 控制台 | — |
| API Key | — |
| 官方文档 | [https://ai.gitee.com/docs](https://ai.gitee.com/docs) |
| 模型/价格 | [https://ai.gitee.com/serverless-api](https://ai.gitee.com/serverless-api) |
| API Base URL | — |
| 鉴权方式 | — |
| 环境变量 | — |
...
| gitee  | `Atria-Dawn-Preview` | Atria Dawn Preview | 256K | 永久免费 | — |
