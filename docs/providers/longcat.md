...
| 项目 | 内容 |
|---|---|
| 内部 Provider ID | `longcat` |
| 官网 | [https://longcat.chat](https://longcat.chat) |
| 注册/登录 | [https://longcat.chat](https://longcat.chat) |
| 控制台 | [https://longcat.chat/platform](https://longcat.chat/platform) |
| API Key | [https://longcat.chat/platform/api-keys](https://longcat.chat/platform/api-keys) |
| 官方文档 | [https://longcat.chat/platform/docs](https://longcat.chat/platform/docs) |
| 模型/价格 | [https://longcat.chat/platform/docs](https://longcat.chat/platform/docs) |
| API Base URL | — |
| 鉴权方式 | bearer |
...
提供每日 token 免费额度，额度和模型范围以官方文档为准。
