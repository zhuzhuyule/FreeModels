...
| nvidia  | `gliner-pii` | gliner-pii | unknown | 试用 credits | NVIDIA NIM free credits, exhaustible |
...
| nvidia  | `nemotron-3-content-safety` | nemotron-3-content-safety | unknown | 试用 credits | NVIDIA NIM free credits, exhaustible |
| nvidia  | `nemotron-content-safety-reasoning-4b` | nemotron-content-safety-reasoning-4b | unknown | 试用 credits | NVIDIA NIM free credits, exhaustible |
| nvidia  | `nemotron-mini-4b-instruct` | nemotron-mini-4b-instruct | unknown | 试用 credits | NVIDIA NIM free credits, exhaustible |
| nvidia  | `nv-embed-v1` | nv-embed-v1 | unknown | 试用 credits | NVIDIA NIM free credits, exhaustible |
| nvidia  | `nv-embedcode-7b-v1` | nv-embedcode-7b-v1 | unknown | 试用 credits | NVIDIA NIM free credits, exhaustible |
