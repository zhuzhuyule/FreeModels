...
|---|---|---|---:|---|---|
| openrouter  | `arcee-ai/trinity-large-thinking:free` | Arcee AI: Trinity Large Thinking (free) | 262K | 限速免费 | Free tier with rate limits (see openrouter.ai) |
| openrouter  | `baidu/cobuddy:free` | Baidu Qianfan: CoBuddy (free) | 131K | 限速免费 | Free tier with rate limits (see openrouter.ai) |
...
| openrouter  | `deepseek/deepseek-v4-flash:free` | DeepSeek: DeepSeek V4 Flash (free) | 1M | 限速免费 | Free tier with rate limits (see openrouter.ai) |
...
| openrouter  | `minimax/minimax-m2.5:free` | MiniMax: MiniMax M2.5 (free) | 205K | 限速免费 | 10000 RPD / Free tier: 10000 req/day (per endpoint, basic account) |
