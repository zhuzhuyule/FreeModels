...
| 项目 | 内容 |
|---|---|
| 内部 Provider ID | `google` |
| 官网 | [https://ai.google.dev](https://ai.google.dev) |
| 注册/登录 | [https://aistudio.google.com](https://aistudio.google.com) |
...
| 模型/价格 | [https://ai.google.dev/gemini-api/docs/models](https://ai.google.dev/gemini-api/docs/models) |
...
Gemini API 部分模型提供免费层，通常带有 RPM / RPD / TPM 限制。
