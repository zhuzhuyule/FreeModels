...
const PROVIDER_LINKS: Record<string, ProviderLinks> = {
  ...
  cloudflare: {
    ...
    freePolicy: '账户级每日 10,000 neurons 免费额度，所有 Workers AI 模型共享。',
  },
  cohere: {
    name: 'cohere',
    displayName: 'Cohere',
    ...
    modelsUrl: 'https://docs.cohere.com/docs/models',
    apiBaseUrl: 'https://api.cohere.com/v1',
    authType: 'bearer',
    envKey: 'COHERE_API_KEY',
    freePolicy: 'Trial key 永久免费：20 RPM、1000 requests/月，所有模型共享配额。',
  },
  github: {
    name: 'github',
    ...
    pricingUrl: 'https://docs.github.com/en/github-models/prototyping-with-ai-models#rate-limits',
    modelsUrl: 'https://github.com/marketplace?type=models',
    apiBaseUrl: 'https://models.github.ai/inference',
    authType: 'bearer',
    envKey: 'GITHUB_TOKEN',
    freePolicy: '按 Copilot 订阅层级（Free / Pro / Pro+ / Business / Enterprise）限速，免费层有较严格的 input/output token 限制。',
  },
  google: {
    name: 'google',
  ...
  sambanova: {
    ...
    modelsUrl: 'https://cloud.sambanova.ai/models',
    apiBaseUrl: 'https://api.sambanova.ai/v1',
    authType: 'bearer',
    envKey: 'SAMBANOVA_API_KEY',
    freePolicy: '新账户提供 $5 trial credits，有效期 3 个月。',
  },
  xinghuo: {
    name: 'xinghuo',
